	...
	$(function() {
		$("#registerForm").validate({
			...
			messages : {
				username : {
					required : "用户名不能为空",
					minlength : "用户名长度不能少于5位字符",
					maxlength : "用户名长度不能超过20位字符",
					isExist : "用户名已存在"
				},
				password : {
					required : "密码不能为空",
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registerForm" class="form-horizontal"
					style="margin-top: 5px;" action="${pageContext.request.contextPath}/register.action"
					method="post">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								...
								name="sex" value="女"> 女
							</label> <label id="sex-error" class="error" for="sex"
								style="display: none;">性别必须选</label>
						</div>
					</div>
					<div class="form-group">
